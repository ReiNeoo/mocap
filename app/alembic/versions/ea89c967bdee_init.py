...
Revision ID: ea89c967bdee
Revises: 
Create Date: 2025-10-09 19:03:36.281873
...
def upgrade() -> None:
    ...
    sa.Column('role_type', sqlmodel.sql.sqltypes.AutoString(length=50), nullable=False),
    sa.Column('id', sa.Uuid(), nullable=False),
    sa.Column('user_id', sa.Uuid(), nullable=False),
    sa.Column('tenant_id', sa.Uuid(), nullable=False),
    sa.Column('created_at', sa.DateTime(), nullable=False),
    ...
    sa.Column('sub_level', sa.Enum('GOLD', 'PREMIUM', 'PRO', name='subscriptionlevel'), nullable=True),
    sa.Column('is_active', sa.Boolean(), nullable=False),
    sa.Column('starts_at', sa.DateTime(), nullable=True),
    sa.Column('ends_at', sa.DateTime(), nullable=True),
    sa.Column('id', sa.Uuid(), nullable=False),
